...
public class GroupCreateActivity extends AppCompatActivity {
    ...
    private void startCreatingGroup() {
        ...
        String groupDescription = groupDescriptionEt.toString().trim();
    ...
    private void pickFromCamera() {
        ...
        cv.put(MediaStore.Images.Media.DESCRIPTION, "Group Image Title Description");
            ...
            case CAMERA_REQUEST_CODE:{
                if (grantResults.length > 0) {
                    ...
                    if (cameraAccepted && storageAccepted) {
                        ...
                        Toast.makeText(this, "Camera & Storage permssions are required", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            break;
